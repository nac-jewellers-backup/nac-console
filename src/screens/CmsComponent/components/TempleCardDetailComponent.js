...
const TempleCardDetailComp = (props) => {
    ...
    const validate = () => {
        if (
            constructedData.content &&
            constructedData.images
                    ...
                    }
                    {
                        ...
                        <Dialog open={open} onClose={handleClose}>
                            ...
                            <DialogContent>
                                        ...
                                        return (
                                            <>
                                                ...
                                                <TextField
                                                    ...
                                                    variant="outlined"
                                                    fullWidth
                                                    onChange={(val) => onChangeData("weigh", val.target.value, "content")}
                                                    value={e.weigh}
                                                    name="weigh"
                                                    required
                                                />
                                                <TextField
                                                    ...
                                                    variant="outlined"
                                                    fullWidth
                                                    onChange={(val) => onChangeData("subtitle", val.target.value, "content")}
                                                    value={e.subtitle}
                                                    name="subtitle"
                                                    required
                                                />
                                                <TextField
                                                    ...
                                                    variant="outlined"
                                                    fullWidth
                                                    onChange={(val) => onChangeData("ContentOne", val.target.value, "content")}
                                                    value={e.ContentOne}
                                                    name="ContentOne"
                                                    required
                                                />
                                                ...
                                                <TextField
                                                    ...
                                                    variant="outlined"
                                                    fullWidth
                                                    onChange={(val) => onChangeData("contentTwo",
                                                        val.target.value, "content")}
                                                    value={e.contentTwo}
                                                    name="contentTwo"
                                                    required
                                                />
                                ...
                                {constructedData.images.length > 0 && constructedData.images.map((e, i) => {
                                    return (
                                        <>
                                            <Grid style={{ textAlign: "center" }} xs={6} md={6} item>
                                                <img
