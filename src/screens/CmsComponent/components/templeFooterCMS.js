            ...
            <Paper className={classes.root}>
                ...
                <Dialog open={open} onClose={handleClose}>
                    ...
                    <DialogContent>
                        <Grid container justifyContent="space-between" alignItems="center">
                            ...
                            <Grid Item xs={5}>
                                <TextField
                                    ...
                                    fullWidth
                                    rows={3}
                                    onChange={(val) => handleAddItem("products", val.target.value)}
                            ...
                            <Grid Item xs={5} >
                                <TextField
                                    ...
                                    fullWidth
                                    rows={3}
                                    onChange={(val) => handleAddItem("location", val.target.value)}
                        ...
                        {
                            state?.sectionOne?.length > 0 && state?.sectionOne?.map((e, i) => {
                                return (
                                    <Grid container justifyContent="space-between" alignItems="center">
                                        ...
                                        <Grid Item xs={5}>
                                            <TextField
                                                ...
                                                fullWidth
                                                rows={3}
                                                onChange={(val) => handleChange("products", val.target.value, i, "sectionOne")}
                                                value={e?.products}
                                                name="products"
                                            />
                                        </Grid>
                                        <Grid Item xs={5} >
                                            <TextField
                                                ...
                                                fullWidth
                                                rows={3}
                                                onChange={(val) => handleChange("location", val.target.value, i, "sectionOne")}
                                                value={e?.location}
                                                name="location"
                                            />
                                        </Grid>
